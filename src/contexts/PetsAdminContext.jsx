...
export const PetsAdminContextProvider = (props) => {
    ...
    return (
        <PetsAdminContext.Provider
            value={{
                petsAdminLoading: isLoading,
                petAdminList: petList,
                petAdminDetail: petDetail,
                listAdminPets: listPetsHandler,
                retrieveAdminPet: retrievePetHandler,
                createAdminPet: createPetHandler,
                createAdminPetError: createPetError
            }}
        >
            {props.children}
        </PetsAdminContext.Provider>
